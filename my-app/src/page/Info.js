...
export const Info = () => {
  ...
  return (
    <div class = "info">
      ...
      <tr class = "contextImport">1. 營期五天四夜中，學員不可擅自離開活動地點。若因個人因素必須離開營隊活動地點，必須簽下離營安全保證書並聯絡其家長。離開營隊之後，學員一切安全事項，本營隊恕不負責。</tr>
      <tr class = "contextImport">2. 由於我們沒有提供火車站(或高鐵站)到營隊地點的交通方式，故報到前的交通與安全需自行負責。</tr>
      <tr class = "contextImport">3. 其餘詳細注意事項請參閱報名簡章: <a target="_blank" href = "https://reurl.cc/ZQdbj3">https://reurl.cc/ZQdbj3</a></tr>
      </table>
